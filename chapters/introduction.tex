...
For the ease of notation, it makes sense to interpret the node numbers as the equivalence classes of $\Z/n\Z$.
...
\begin{proof}[Proof (Sketch)]
	...
	This problem asks whether, given an instance $J$ consisting of $m$ positive integers $\{z_1, \ldots, z_m\} \subset \N$, there exists a subset $S \subseteq [m]$ such that 
	\begin{equation}
