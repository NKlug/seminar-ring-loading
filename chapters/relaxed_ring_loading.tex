...
Afterwards, the capacities of all of all edges that $d_{i, j}$ is routed through are decreased by $d_{i, j}$ and the demands across the cuts are adjusted similary.
