...
%	\hspace{1cm}
	\begin{minipage}[t]{.4\textwidth}
		...
		l1_red/.style={thick, red!80!black},
		scale=1, transform shape]
			...
			\draw[<->] (2)  to [out=-22.5,in=-112.5] (-22.5:2.8) to [out=67.5,in=-22.5](5);

			\node (b) at (-15:2.46) {$d_{2, 4}$};
			\draw[<->] (2)  to [out=-15,in=-135] (-45:2.25) to [out=45,in=-75] (4);
			
			\node (c) at (135:2.7) {$d_{6, 8}$};
			\draw[<->] (6)  to [out=157.5,in=45] (135:2.4) to [out=-135,in=112.5] (8);
	...
	The red edge is the only edge in between $d_{2, 4}$ and $d_{2, 5}$.}
